...
OMX_ERRORTYPE aw_omx_component_init(OMX_IN OMX_HANDLETYPE pHComp, OMX_IN OMX_STRING pComponentName)
{
	...
	aw_omx_component *pThis = (pHComp)? (aw_omx_component *)(((OMX_COMPONENTTYPE *)pHComp)->pComponentPrivate):NULL;
                                           ...
                                           OMX_OUT OMX_UUIDTYPE*       pComponentUUID)
{
	...
	if(pThis)
	{
		eReturn = pThis->get_component_version(pHComp,pComponentName,pComponentVersion,pSpecVersion,pComponentUUID);
	}
