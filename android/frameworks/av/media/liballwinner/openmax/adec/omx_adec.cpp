                                       ...
                                       OMX_INOUT OMX_PTR     pParamData)
{
    ...
    switch(eParamIndex)
    {
        ...
        case OMX_IndexParamPortDefinition:
        {
            ...
            if (((OMX_PARAM_PORTDEFINITIONTYPE *)(pParamData))->nPortIndex == m_sInPortDef.nPortIndex)
            {
                memcpy(pParamData, &m_sInPortDef, sizeof(OMX_PARAM_PORTDEFINITIONTYPE));logd("****eDomain:%d,eEncoding:%d",m_sInPortDef.eDomain,m_sInPortDef.format.audio.eEncoding);
                logd(" get_OMX_IndexParamPortDefinition: m_sInPortDef.nPortIndex[%d]", (int)m_sInPortDef.nPortIndex);
            }
            else if (((OMX_PARAM_PORTDEFINITIONTYPE*)(pParamData))->nPortIndex == m_sOutPortDef.nPortIndex)
            {
                memcpy(pParamData, &m_sOutPortDef, sizeof(OMX_PARAM_PORTDEFINITIONTYPE));logd("****eDomain:%d,eEncoding:%d",m_sOutPortDef.eDomain,m_sOutPortDef.format.audio.eEncoding);
            ...
            else
            {
                ...
                logd(" get_OMX_IndexParamPortDefinition: error. pParamData->nPortIndex=[%d]", (int)((OMX_PARAM_PORTDEFINITIONTYPE*)(pParamData))->nPortIndex);
            }
        ...
        case OMX_IndexParamAudioPortFormat:
        {
            ...
            if (((OMX_AUDIO_PARAM_PORTFORMATTYPE *)(pParamData))->nPortIndex == m_sInPortFormat.nPortIndex)
            {
                if (((OMX_AUDIO_PARAM_PORTFORMATTYPE*)(pParamData))->nIndex > m_sInPortFormat.nIndex)
                {
            ...
            else if (((OMX_AUDIO_PARAM_PORTFORMATTYPE*)(pParamData))->nPortIndex == m_sOutPortFormat.nPortIndex)
            {
                if (((OMX_AUDIO_PARAM_PORTFORMATTYPE*)(pParamData))->nIndex > m_sOutPortFormat.nIndex)
                {
                    eError = OMX_ErrorNoMore;
                }
                else
                {
                    memcpy(pParamData, &m_sOutPortFormat, sizeof(OMX_AUDIO_PARAM_PORTFORMATTYPE));
                }
            }
            else
            {
...
OMX_ERRORTYPE  omx_adec::set_parameter(OMX_IN OMX_HANDLETYPE pHComp, OMX_IN OMX_INDEXTYPE eParamIndex,  OMX_IN OMX_PTR pParamData)
{
    OMX_ERRORTYPE         eError      = OMX_ErrorNone;
    ...
    switch(eParamIndex)
    {
        case OMX_IndexParamPortDefinition:
        {
            ...
            if (((OMX_PARAM_PORTDEFINITIONTYPE *)(pParamData))->nPortIndex == m_sInPortDef.nPortIndex)
            {
                ...
                if(((OMX_PARAM_PORTDEFINITIONTYPE *)(pParamData))->nBufferCountActual != m_sInPortDef.nBufferCountActual)
                {
                    int nBufCnt;
                    int nIndex;
            ...
            else if (((OMX_PARAM_PORTDEFINITIONTYPE *)(pParamData))->nPortIndex == m_sOutPortDef.nPortIndex)
            {
                ...
                if(((OMX_PARAM_PORTDEFINITIONTYPE *)(pParamData))->nBufferCountActual != m_sOutPortDef.nBufferCountActual)
                {
                    int nBufCnt;
                    int nIndex;
...
OMX_ERRORTYPE  omx_adec::get_config(OMX_IN OMX_HANDLETYPE pHComp, OMX_IN OMX_INDEXTYPE eConfigIndex, OMX_INOUT OMX_PTR pConfigData)
{
    OMX_ERRORTYPE eError = OMX_ErrorNone;
...
OMX_ERRORTYPE omx_adec::set_config(OMX_IN OMX_HANDLETYPE pHComp, OMX_IN OMX_INDEXTYPE eConfigIndex, OMX_IN OMX_PTR pConfigData)
{
...
OMX_ERRORTYPE  omx_adec::get_extension_index(OMX_IN OMX_HANDLETYPE pHComp, OMX_IN OMX_STRING pParamName, OMX_OUT OMX_INDEXTYPE* pIndexType)
{
    unsigned int  nIndex;
    ...
    {
        if(strcmp((char *)pParamName, (char *)&(sAudioDecCustomParams[nIndex].cCustomParamName)) == 0)
        {
            ...
            //while(1)
            {
             //   logd("**********decode start");logd("mFirstInputDataFlag:%d,nSizeOfList:%d",pSelf->mFirstInputDataFlag,(int)pSelf->m_sInBufList.nSizeOfList);
                ...
                if((decodeResult==ERR_AUDIO_DEC_NONE)&&((pSelf->m_channel != pSelf->m_streamInfo.nChannelNum)||(pSelf->m_sampleRate != pSelf->m_streamInfo.nSampleRate)))
                {
                    ...
                    pSelf->m_Callbacks.EventHandler(&pSelf->mOmxCmp, pSelf->m_pAppData, OMX_EventPortSettingsChanged, 0x01/*pSelf->m_sOutPortDef.nPortIndex*/, OMX_IndexConfigCommonOutputCrop, NULL);
