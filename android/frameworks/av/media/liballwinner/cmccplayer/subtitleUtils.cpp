...
#define MAX_OUTPUT_TEXT_SIZE (1024)
    ...
    parcelDst->writeInt32((int)(pSubItem->nPts/1000)); //* pts in unit of us, write out pts in unit of ms.
...
// The Parcel will be sent to MediaPlayer.java through event, and will be
// parsed in TimedText.java.
int SubtitleUtilsFillBitmapSubtitleToParcel(Parcel* parcelDst, SubtitleItem* pSubItem, int nSubtitleID)
{
    int nBufSize;
