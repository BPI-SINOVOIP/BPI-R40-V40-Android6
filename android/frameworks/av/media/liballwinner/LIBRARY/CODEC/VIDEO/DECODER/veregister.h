...
static const char* REG_GROUP_NAME[] = {"Top Level", "Mpeg 1/2/4", "H264/AVS", "VC-1", "RV", "H265", "JPEG"};
...
typedef struct VETOP_REG_STATUS
{
    ...
    volatile unsigned int isp_intr                  :1;    //* in 1633, this bit is not used.
    volatile unsigned int ave_intr                  :1;    //* in 1633, this bit is not used.
    volatile unsigned int mpe_intr                  :1;    //* in 1633, this bit is ave_intr.
    ...
    volatile unsigned int graphic_intr              :1;    //* in 1633, this bit is not used.
    volatile unsigned int graphic_intr_enable       :1;    //* in 1633, this bit is not used.
    ...
    volatile unsigned int graphic_cmd_queue_busy    :1;    //* in 1633, this bit is not used.
    volatile unsigned int graphic_busy              :1;    //* in 1633, this bit is not used.
    
    //* the following 1 bit is for 1619, 1620, 1623, ...
    volatile unsigned int maf_busy                  :1;    //* in 1633, this bit is not used.
    
    volatile unsigned int esp_mode                  :1;    //* in 1633, this bit is not used.
}vetop_reg_status_t;
...
{    
     volatile unsigned int anaglyph_src_mode    : 2;    //* 00: source mode; 01: top/down or over/under; 10: line by line; 11: separate.
     volatile unsigned int reserved2            : 1;    
     volatile unsigned int irec_is_right        : 1;    //* 0: left, 1: right.
     volatile unsigned int anaglyph_proc_mode   : 3;    //* 000: read/bule, 001: red/green, 010: red cyan, 011: color, 100: half color, 101: optimized, 110: yello/blue, 111: reserved.
     volatile unsigned int reserved1            : 1;
     volatile unsigned int yuv2rgb_mode         : 2;    //* 00: YCC, 01: BT601, 10: BT709.
     volatile unsigned int reserved0            : 21;
     volatile unsigned int anaglyph_out_enable  : 1;    //* 0: disable, 1: enable.
...
typedef struct VETOP_REG_CHROMA_BUF_LEN0
{
	...
	//volatile unsigned int reserved0                 :1;
	volatile unsigned int luma_align_mode			:1;    //* 0: 16-bytes aligned, 1: 32-bytes aligned. for 1639
	volatile unsigned int chroma_align_mode         :1;    //* 0: 16-bytes aligned, 1: 8-bytes aligned.
	volatile unsigned int output_data_format        :2;    //* 00: 32x32 tile-based, 01: reserved, 10: YUV planer format, 11: YVU planer foramt.
...
{
   	volatile unsigned int second_special_output_format		:3;    //* 000: 32*32 tile-based, 001: 128*32 tile-based, 010: YU12, 011: YV12, 100: NV12, 101: NU12
   	volatile unsigned int reserved0							:1;
   	volatile unsigned int primary_output_format				:3;    //* 0: 16-bytes aligned, 1: 8-bytes aligned.
...
typedef struct VETOP_REGISTER_LIST
{
    ...
    vetop_reg_maf_ctrl_t                    _30_maf_ctrl;             //* not used in 1633.
    vetop_reg_maf_th_clip_t                 _34_maf_th_clip;          //* not used in 1633.
    vetop_reg_maf_ref1_luma_addr_t          _38_maf_ref1_luma_addr;   //* not used in 1633.
    vetop_reg_maf_ref1_chroma_addr_t        _3c_maf_ref1_chroma_addr; //* not used in 1633.
    vetop_reg_cur_frame_maf_addr_t          _40_cur_maf_addr;         //* not used in 1633.
    vetop_reg_ref1_frame_maf_addr_t         _44_ref1_maf_addr;        //* not used in 1633.
    vetop_reg_ref2_frame_maf_addr_t         _48_ref2_maf_addr;        //* not used in 1633.
    vetop_reg_maf_max_group_diff_t          _4c_maf_max_group_diff;   //* not used in 1633.
    ...
    vetop_reg_argb_cmd_queue_start_t        _5c_argb_cmd_queue_start;  //* not used in 1633.
    vetop_reg_argb_src1_blk_addr_t          _60_argb_src1_blk_addr;    //* not used in 1633.
    vetop_reg_argb_src2_blk_addr_t          _64_argb_src2_blk_addr;    //* not used in 1633.
    vetop_reg_argb_target_blk_addr_t        _68_argb_target_blk_addr;  //* not used in 1633.
    vetop_reg_argb_scr_pix_stride_t         _6c_argb_src_pix_stride;   //* not used in 1633.
    vetop_reg_argb_target_pix_stride_t      _70_argb_target_pix_stride; //* not used in 1633.
    vetop_reg_argb_blk_size_t               _74_argb_blk_size;         //* not used in 1633.
    vetop_reg_argb_value_to_fill_t          _78_argb_value_to_fill;    //* not used in 1633.
    vetop_reg_argb_blk_ctrl_t               _7c_argb_blk_ctrl;         //* not used in 1633.
    
    vetop_reg_luma_hist_threshold_t         _80_luma_hist_threshold[4]; //* not used in 1633.
    vetop_reg_luma_hist_value_t             _90_luma_hist_value[12];    //* not used in 1633.
    ...
    vetop_reg_dbg_ctrl_t                    _f8_dbg_ctrl;                //* not used in 1633.
    vetop_reg_dbg_output_t                  _fc_dbg_output;              //* not used in 1633.
