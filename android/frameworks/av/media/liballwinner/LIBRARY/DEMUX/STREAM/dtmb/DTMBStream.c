...
static cdx_int32 __DTMBStreamRead(CdxStreamT *stream, cdx_void *buf, cdx_uint32 len)
{
    struct CdxDTMBStreamImplS *impl;
    cdx_int32 ret = 0;
...
static cdx_int32 __DTMBStreamControl(CdxStreamT *stream, cdx_int32 cmd, cdx_void *param)
{
...
static cdx_int32 __DTMBStreamGetMetaData(CdxStreamT *stream, const cdx_char *key, cdx_void **pVal)
{
	CDX_LOGD("enter:%s %d\n",__FUNCTION__,__LINE__);
