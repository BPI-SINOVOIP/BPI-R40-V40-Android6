...
int aw_mms_http_streaming_start(CdxDataSourceT* datasource, aw_mms_inf_t* mmsStreamInf)
{
    ...
    pos = MmshFindAsfGuid(mmsStreamInf->firstChunk, asfFileHeaderGuid, start, mmsStreamInf->firstChunkBodySize); /*ASF_File_Properties_Object GUID and object size*/
    if(pos >= 0)
    {
    ...
    pos = start;
    while((pos = MmshFindAsfGuid(mmsStreamInf->firstChunk, asfStreamHeaderGuid, pos, mmsStreamInf->firstChunkBodySize)) >= 0) /*ASF_Stream_Properties_Object GUID and object size*/
    {
     ...
     pos = MmshFindAsfGuid(mmsStreamInf->firstChunk, asfStreamGroupGuid, start, mmsStreamInf->firstChunkBodySize); /*ASF_Stream_Bitrate_Properties_Object*/
     if (pos >= 0)
     {
