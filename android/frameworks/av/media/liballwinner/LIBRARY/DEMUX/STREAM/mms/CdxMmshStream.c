...
const char asfStreamGroupGuid[16] = {0xce, 0x75, 0xf8, 0x7b,   //ASF_Stream_Bitrate_Properties_Object
...
{   
    ...
    pos = start;
    while((pos = MmshFindAsfGuid(buffer, asfStreamHeaderGuid, pos, size)) >= 0) /*ASF_Stream_Properties_Object GUID and object size*/
    {
     ...
     pos = MmshFindAsfGuid(buffer, asfStreamGroupGuid, start, size); /*ASF_Stream_Bitrate_Properties_Object*/
     if (pos >= 0)
     {
