...
int AtracId3v2Match(const cdx_int8 *pBuf, const char *pMagic)
{
...
int AtracId3v2TagLen(const cdx_int8 *pBuf)
{
...
{
    unsigned mTaglen = 0;
    if (AtracId3v2Match(p->buf, ID3v2_EA3_MAGIC)) 
        mTaglen = AtracId3v2TagLen(p->buf);
