...
public final class PowerManager {
	...
	private final String AW_WAKELOCK_IGNORE_STRING_1 = "Checkin Service";
	private final String AW_WAKELOCK_IGNORE_STRING_2 = "Checkin Handoff";
	private final String AW_WAKELOCK_IGNORE_STRING_3 = "com.google.android.gms";
   ...
   /**
    ...
    public final class WakeLock {
        ...
        protected void finalize() throws Throwable {
            synchronized (mToken) {
				if (mTag.equals(AW_WAKELOCK_IGNORE_STRING_1)
						|| mTag.equals(AW_WAKELOCK_IGNORE_STRING_2)
						&& mPackageName.equals(AW_WAKELOCK_IGNORE_STRING_3)) {
					Log.w(TAG, "Ignore checkin related wakelocks: " + mTag);
					return;
				}
                if (mHeld) {
