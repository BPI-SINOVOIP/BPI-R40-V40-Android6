...
public class PackageParser {
    ...
    private boolean parseBaseApplication(Package owner, Resources res,
        ...
        //ignore google package installer dialog theme.
        if (ai.packageName != null && "com.google.android.packageinstaller".equals(ai.packageName)
            && "QuadCore-A33".equals(SystemProperties.get("ro.sys.cputype", ""))) {
            ai.theme = 0x0103012c; //Theme.DeviceDefault.Light.NoActionBar
        }
