...
public final class SQLiteConnection implements CancellationSignal.OnCancelListener {
    ...
    private void setLocaleFromConfiguration() {
        ...
        try {
            ...
            Log.w(TAG, "Failed to select locale from db '" + mConfiguration.label + "'.", ex);
            execute("DROP TABLE android_metadata", null, null);
            execute("CREATE TABLE android_metadata (locale TEXT)", null, null);
        }
