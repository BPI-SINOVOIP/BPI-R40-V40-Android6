...
public class ActivityManager {
    ...
    static public boolean isHighEndGfx() {
        return !(isLowRamDeviceStatic() && (SystemProperties.getBoolean("ro.config.512m", false)))&& !Resources.getSystem().getBoolean(com.android.internal.R.bool.config_avoidGfxAccel);
    }
