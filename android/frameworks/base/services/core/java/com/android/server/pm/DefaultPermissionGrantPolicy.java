...
final class DefaultPermissionGrantPolicy {
    ...
    private void grantDefaultSystemHandlerPermissions(int userId) {
        ...
        synchronized (mService.mPackages) {
            ...
            // Voice interaction
            if (voiceInteractPackageNames != null && shouldEnableVoiceService()) {
            ...
            if (voiceRecoPackage != null && shouldEnableVoiceService()
    ...
    private boolean shouldEnableVoiceService() {
        boolean isLowRamDevice = "true".equals(SystemProperties.get("ro.config.low_ram", "false"));
        boolean isForce = false;
        if (mService != null && mService.mContext != null && mService.mContext.getResources() != null) {
            isForce = !TextUtils.isEmpty(mService.mContext.getResources().getString(com.android.internal.R.string.config_forceVoiceInteractionServicePackage));
        }
        return (!isLowRamDevice) || isForce;
    }
}
