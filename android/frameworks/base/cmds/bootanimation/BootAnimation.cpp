...
status_t BootAnimation::readyToRun() {
    ...
    char mBootanim[PROPERTY_VALUE_MAX];
    property_get("service.bootanim.exit", mBootanim, "");
    sp<SurfaceControl> control = session()->createSurface(String8("BootAnimation"),
            (dinfo.orientation % 2 == 0  || atoi(mBootanim) == 0) ? dinfo.w : dinfo.h, (dinfo.orientation % 2 == 0  || atoi(mBootanim) == 0) ? dinfo.h : dinfo.w, PIXEL_FORMAT_RGB_565);
