...
#define EMCE_SECTOR_SIZE_BIT	(16<<1)
#define EMCE_CUR_CTR_BIT		(1<<12)
#define EMCE_IV_LEN_BIT			(1<<10)
#define EMCE_KEY_LEN_BIT		(1<<4)
#define EMCE_MODE_BIT			(1<<0)
...
static inline void sunxi_emce_set_bit(void __iomem *reg_addr, u32 mask, u32 val)
{
	u32 reg_val = 0;
